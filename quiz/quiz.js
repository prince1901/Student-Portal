...
let timeText = document.querySelector(".time_left_txt");
...
function optionSelected(answer){
    clearInterval(counter); //clear counter
    clearInterval(counterLine); //clear counterLine
    let userAns = answer.textContent; //select option
    let correcAns = questions[que_count].answer; //getting correct answer 
    let allOptions = option_list.children.length; //getting all option 
    
    if(userAns == correcAns){ //if user selected option  equal to array's correct answer
